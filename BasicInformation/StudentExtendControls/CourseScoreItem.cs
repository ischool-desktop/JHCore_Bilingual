...
{
    [FCode("JHSchool.Student.Detail0052", "學生修課")]
            ...
            if (MsgBox.Show(string.Format("您確定要刪除課程「{0}」的修課記錄及相關評量成績嗎？", course.Name), MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                if (sces.Count > 0)
                {
                    ...
                    foreach (var sce in sces)
                    {
                        ...
                        logSaver.AddBatch("雙語部.學生修課", "刪除評量成績", "student", PrimaryKey, desc);
                    }
                    logSaver.LogBatch();
                }
                ...
                if (scattends.Count > 0)
                {
                    ...
                    FISCA.LogAgent.ApplicationLog.Log("雙語部.學生修課", "刪除修課", "student", PrimaryKey, builder.ToString());
                }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (form.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    FISCA.LogAgent.ApplicationLog.Log("雙語部.學生修課", "新增修課", "student", PrimaryKey, builder.ToString());
                }
                catch (Exception ex)
                {
