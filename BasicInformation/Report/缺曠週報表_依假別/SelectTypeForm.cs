...
namespace BasicInformation
{
    public partial class SelectTypeForm : BaseForm
    {
        ...
        void _BGWAbsenceAndPeriodList_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            foreach (K12.Data.PeriodMappingInfo var in K12.Data.PeriodMapping.SelectAll())
            {
                if (!typeList.Contains(var.Type))
                    typeList.Add(var.Type);
            }

            foreach (K12.Data.AbsenceMappingInfo var in K12.Data.AbsenceMapping.SelectAll())
            {
